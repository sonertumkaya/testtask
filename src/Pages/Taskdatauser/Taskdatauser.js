...
import { DataGridPremium , GridToolbar, GridColDef,trTR,GridActionsCellItem,  GridRowId,  GridColumns, } from '@mui/x-data-grid-premium';
...
useEffect (() => persons(),[]);
 ...
 const onInputChangeSelect = (e) => {
  ...
  const handleEdit = (event, cellValues) => {
   // console.log(row);
    setOpen(true);
    setEditTask({id:cellValues.row.id,	no:cellValues.row.no,	siparisci:cellValues.row.siparisci,	msahs:cellValues.row.msahs	,alayihe:cellValues.row.alahiye,	amodul:cellValues.row.amodul,	deyeri:cellValues.row.deyeri,	starih:cellValues.row.starih,	btarih:cellValues.row.btarih,	kqeyd:cellValues.row.kqeyd,	emalumat:cellValues.row.emalumat	,file:cellValues.row.file	});
   
   // setEditTask({id:cellValues.row.id,	no:cellValues.row.no,	siparisci:cellValues.row.siparisci,	msahs:cellValues.row.msahs	,alayihe:cellValues.row.alahiye,	amodul:cellValues.row.amodul,	deyeri:cellValues.row.deyeri,	starih:cellValues.row.starih,	btarih:cellValues.row.btarih,	kqeyd:cellValues.row.kqeyd,	emalumat:cellValues.row.emalumat	,file:cellValues.row.file	});
    setEditTaskS({oncelik:cellValues.row.oncelik	});
  }
    ...
    <div className="modal-dialog sidebar-lg">
      <div className="modal-content p-0">
        ...
        <div className="modal-header mb-1">
          <h5 className="modal-title">Redakte Proje</h5>
        </div>
          ...
          <ul className="nav nav-tabs tabs-line">
            <li className="nav-item">
              <a className="nav-link nav-link-update active" data-bs-toggle="tab" href="#tab-update">
                ...
                <span className="align-middle">Redakte</span>
              </a>
            </li>
            <li className="nav-item">
