...
const Struktur = ({Struktur}) => {
    ...
    const {deleteStruktur} = useContext(StrukturContext)
    ...
    return (
        <>
            ...
            <td>
                ...
                <OverlayTrigger
                    ...
                    <button onClick={() => deleteStruktur(Struktur.id)}  className="btn text-danger btn-act" data-toggle="modal"><svg xmlns="http://www.w3.org/2000/svg" width="14px" height="14px" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-50 feather feather-trash"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></button>
                </OverlayTrigger>
        ...
        <Modal.Header closeButton>
            <Modal.Title>
            Strukturu redaktə edin
            </Modal.Title>
        </Modal.Header>
        <Modal.Body>
            <EditForm theStruktur={Struktur} />
        </Modal.Body>
        <Modal.Footer>
