...
const Pagination = ({pages, setCurrentPage, currentBildiris, sortedBildiris}) => {
    ...
    return (
        ...
        <div className="hint-text"> <b>{currentBildiris.length}</b> məlumatdan<b>{sortedBildiris.length}</b> göstərilir</div>
