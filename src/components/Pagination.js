...
const Pagination = ({pages, setCurrentPage, currentStrukturs, sortedStrukturs}) => {
    ...
    return (
        ...
        <div className="hint-text"> <b>{currentStrukturs.length}</b> məlumatdan  <b>{sortedStrukturs.length}</b> göstərilir</div>
