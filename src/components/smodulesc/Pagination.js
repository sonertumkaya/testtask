...
const Pagination = ({pages, setCurrentPage, currentSModuls, sortedSModuls}) => {
    ...
    return (
        ...
        <div className="hint-text"> <b>{currentSModuls.length}</b> məlumatdan<b>{sortedSModuls.length}</b> göstərilir</div>
