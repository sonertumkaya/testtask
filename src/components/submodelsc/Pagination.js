...
const Pagination = ({pages, setCurrentPage, currentRoles, sortedRoles}) => {
    ...
    return (
        ...
        <div className="hint-text"> <b>{currentRoles.length}</b> məlumatdan<b>{sortedRoles.length}</b> göstərilir</div>
