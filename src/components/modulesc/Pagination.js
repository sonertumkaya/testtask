...
const Pagination = ({pages, setCurrentPage, currentModuls, sortedModuls}) => {
    ...
    return (
        ...
        <div className="hint-text"> <b>{currentModuls.length}</b> məlumatdan<b>{sortedModuls.length}</b> göstərilir</div>
